"""
النماذج المُشكّلة مسبقاً للوضع التجريبي
تُستخدم عندما لا يكون نموذج CATT محمّلاً

يحتوي على:
    - DEMO_PAIRS: أزواج (نص خام → نص مشكّل)
    - SAMPLE_CATEGORIES: تصنيف النماذج للعرض في الشريط الجانبي
"""

# ═══════════════════════════════════════════════════
#     أزواج النصوص: الأصلي → المشكّل
# ═══════════════════════════════════════════════════
DEMO_PAIRS = {
    # ── آيات قرآنية ──
